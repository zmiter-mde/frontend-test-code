...
import { pooledMap } from "./pooledMapCustom"

describe("PooledMapCustom utils", () => {
  test("runs correctly", async () => {
    ...
    expect(result).toEqual(arr.map((elem) => elem * 2))
  }, 10500)
  ...
  test("runs correctly with random timeouts", async () => {
